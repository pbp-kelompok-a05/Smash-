...
urlpatterns = [
    ...
    path("<uuid:comment_id>/", views.CommentAPIView.as_view(), name="comment-detail"),
    # Comment interactions (like, report)
    path(
        "<uuid:comment_id>/<str:action>/",
    ...
    path(
        "admin/comments/<uuid:comment_id>/",
        views.CommentAPIView.as_view(),
