...
urlpatterns = [
    ...
    path(
        "api/posts/<uuid:post_id>/", views.PostAPIView.as_view(), name="post_api_detail"
    ),
    # Post Interactions (Like, Dislike, Report, Share)
    path(
        "api/posts/<uuid:post_id>/<str:action>/",
    ...
    # Halaman Edit Post
    path("edit/<uuid:post_id>/", views.edit_post_page, name="edit_post_page"),
